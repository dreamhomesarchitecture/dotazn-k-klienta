...
module.exports = async (req, res) => {
  try {
    ...
    if (req.method === "PATCH") {
      ...
      const allowedFields = ["clientName", "clientBuildType", "clientLocation"];
      ...
      const existing = JSON.parse(Buffer.from(fileData.content, "base64").toString("utf-8"));
      for (const field of allowedFields) {
        if (Object.prototype.hasOwnProperty.call(updates, field)) existing[field] = updates[field];
      }
